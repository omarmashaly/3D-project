...
static GLfloat headRotation=110.0F ;
static GLfloat zoom=-320.0f;// This is the camera zoom for the perception of the FOV
...
void Initialize(void)
{
    ...
    glClearColor(0.0f, 0.0f, 0.6f, 1.0f); //Change the background
...
void DrawSnake(){
    ...
    glLoadIdentity();                  // Reset the model-view matrix
    glTranslatef(4.5f, -2.0f, -8.0f);  // Move left and into the screen
